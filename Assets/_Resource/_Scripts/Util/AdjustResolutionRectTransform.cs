    ...
    public class AdjustResolutionRectTransform : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (generation == DeviceGeneration.iPhoneX ||
                generation == DeviceGeneration.iPhoneXS ||
                generation == DeviceGeneration.iPhoneXR ||
                generation == DeviceGeneration.iPhoneXSMax ||
                generation == DeviceGeneration.iPhone11 ||
                generation == DeviceGeneration.iPhone11Pro ||
                generation == DeviceGeneration.iPhone11ProMax ||
                generation == DeviceGeneration.iPhoneXR)
            {
                if (isPortrait)
                {
