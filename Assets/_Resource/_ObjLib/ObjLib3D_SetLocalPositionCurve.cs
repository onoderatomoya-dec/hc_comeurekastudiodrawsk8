...
*/
public class ObjLib3D_SetLocalPositionCurve : ObjLib
{
    private int _flame;
    ...
    public ObjLib3D_SetLocalPositionCurve(GameObject obj, Vector3 newPos, int flame, bool isFirstSlow, Action releaseEvent)
    {
