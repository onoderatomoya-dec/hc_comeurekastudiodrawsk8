...
*/
public class ObjLib2D_AlphaTextMeshProUGUISetMove : ObjLib
{
    ...
    public ObjLib2D_AlphaTextMeshProUGUISetMove(GameObject obj,float alpha,int flame,bool loop, Action releaseEvent)
    {
        base.Init(obj,releaseEvent);
        _flame = flame;
        _alpha = alpha;
        _loop = loop;
        _image = obj.transform.GetComponent<TextMeshProUGUI>();
